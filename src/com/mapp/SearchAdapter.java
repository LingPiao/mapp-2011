...
public class SearchAdapter extends BaseAdapter {
	...
	public SearchAdapter(Context contex) {
		inflater = LayoutInflater.from(contex);
	}

	public void search(String searchText) {
		// List<Phone> phones = XmlUtils.loadPhones(Constants.SEARCH_URL +
		// searchText);
		List<Phone> phones = XmlUtils.loadPhones(Constants.SEARCH_URL);
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		myHolder.actionImage.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Map<String, Object> selected = (HashMap<String, Object>) SearchAdapter.this.getItem(p);
				...
				XmlUtils.saveFavorites(SearchAdapter.this.inflater.getContext().getFilesDir().getAbsolutePath());
