...
public class FavoriteListAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		myHolder.actionImage.setImageResource(R.drawable.list_remove);
		...
		myHolder.actionImage.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Map<String, Object> selected = (HashMap<String, Object>) FavoriteListAdapter.this.getItem(p);
				list.remove(p);
				MyFavoriteHolder.getInstance().remove(selected.get("phoneId").toString());
				FavoriteListAdapter.this.notifyDataSetChanged();
				XmlUtils.saveFavorites(FavoriteListAdapter.this.inflater.getContext().getFilesDir().getAbsolutePath());
				Toast.makeText(v.getContext(), "Position=" + p + ",id=" + selected.get("phoneId") + " removed.", Toast.LENGTH_SHORT).show();
			}
		});
		return convertView;
	}
